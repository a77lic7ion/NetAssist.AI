...
import { Router, Server, Shield, Box } from 'lucide-react';
...
export const DevicePalette: React.FC = () => {
  ...
  return (
    <div className="absolute top-4 left-4 bg-white p-2 rounded-lg shadow-md z-10 flex flex-col gap-2 border border-gray-200">
      <h3 className="text-xs font-semibold text-gray-500 mb-1 px-1">Devices</h3>
      {devices.map((device) => (
        <div
          key={device.type}
